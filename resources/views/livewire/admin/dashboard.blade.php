<div class="min-h-screen bg-gray-50">
    ...
    <x-card title="Applications ({{ date('Y') }})" subtitle="Current year applications overview" separator class="mt-5 border-2 border-gray-200">
    ...
    <x-card title="Registrations ({{ date('Y') }})" subtitle="Current year registrations overview" separator class="mt-5 border-2 border-gray-200">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div class="stats shadow">
                <div class="stat">
                    <div class="stat-figure text-primary">
    ...
    {{-- Revenue Statistics --}}
    <x-card title="Revenue ({{ date('Y') }})" subtitle="Current year revenue overview" separator class="mt-5 border-2 border-gray-200">
    ...
    {{-- Recent Applications --}}
    <x-card title="Recent Applications" subtitle="Latest 10 applications" separator class="mt-5 border-2 border-gray-200">
        <x-slot:menu>
            <x-button 
                icon="o-arrow-right" 
                label="View All" 
    ...
    {{-- Quick Actions --}}
    <x-card title="Quick Actions" separator class="mt-5 border-2 border-gray-200">
