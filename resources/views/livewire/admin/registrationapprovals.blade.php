<div>
    ...
    @can('registrations.access')
    <x-card title="Registration Approvals ({{ $customerprofessions->count() }})" separator class="mt-5 border-2 border-gray-200">
        <x-slot:menu>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center justify-end space-x-2">
                          <x-button icon="o-eye" label="View" class="btn-sm btn-info btn-outline" link="{{ route('registrationapprovals.show',['uuid'=>$customerprofession->uuid]) }}"  spinner />
                        </div>
                    </td>
                </tr>
                @empty
