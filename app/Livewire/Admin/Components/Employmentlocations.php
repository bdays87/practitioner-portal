...
class Employmentlocations extends Component
{
    use Toast;
    public $name;
    public $search;
    ...
    public function boot(iemploymentlocationInterface $repo){
        $this->repo = $repo;
    }
    ...
    {
        return view('livewire.admin.components.employmentlocations',[
