...
class Qualificationlevels extends Component
{
    use Toast;
    public $name;
    public $search;
    ...
    public $id;
    public function boot(iqualificationlevelInterface $repo){
        $this->repo = $repo;
    }
    ...
    {
        return view('livewire.admin.components.qualificationlevels',[
            'qualificationlevels'=>$this->getqualificationlevels(),
