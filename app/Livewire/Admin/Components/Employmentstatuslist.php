...
class Employmentstatuslist extends Component
{
    use Toast;
    public $name;
    public $search;
    ...
    public $id;
    public function boot(iemploymentstatusInterface $repo){
        $this->repo = $repo;
    }
    ...
    {
        return view('livewire.admin.components.employmentstatuslist',[
